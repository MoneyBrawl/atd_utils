...
setup(
    name="atd_utils",
    version="0.1.0",
    description="Utilities for pulling, manipulating, and visualizing data for Attack The Data projects",
    long_description=readme + "\n\n" + history,
    author="Ben Leathers",
    author_email="benjaminleathers@gmail.com",
    url="https://github.com/MoneyBrawl/atd_utils",
    packages=[
        "atd_utils",
    ],
    package_dir={"atd_utils": "atd_utils"},
